'''
This example is to find out the largest population (largest number of 
organisms that can be created) before hitting memory limit.

In this simulation,
    - construct world
    - construct 1 population of incremental number of organisms (from 
    100 and increment by 100)
    - each organism has 1 chromosome of 10 thousand bases as genome
'''
...
parameters = {# Part 1: Simulation metadata
              "simulation_name": "31_construct_simulation",
...
while True:
  ...
  end_time = time.time()
  print(pop_size, end_time-start_time)
