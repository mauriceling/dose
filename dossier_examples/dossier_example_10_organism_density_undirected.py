"""!
Example 10 of DOSSIER [Functions to Analyze Simulation Results 
Database and Periodic Archives from DOSE (Digital Organism Simulation 
Environment) Simulations] - Process Density (Undirected) Scores. 
...
fitnessFunction = dossier.MeasureDensity
fitnessDF = dossier.GenerateFitness(fitnessFunction, simSet, db, 
                                    measure=metab.enzymatic_reactions,
                                    len_of_measure=2,
                                    type_of_measure="undirected")
print("Fitness Score Data Frame ..............................")
print(fitnessDF)

dossier.SaveDataframe(fitnessDF, "dossier_example_10.csv", "csv")
dossier.SaveDataframe(fitnessDF, "dossier_example_10.xlsx", "xlsx")
