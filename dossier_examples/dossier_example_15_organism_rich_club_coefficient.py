"""!
Example 15 of DOSSIER [Functions to Analyze Simulation Results 
Database and Periodic Archives from DOSE (Digital Organism Simulation 
Environment) Simulations] - Process Rich Club Coefficient Scores. 

Date created: 4th January 2022
"""
try: 
...
fitnessFunction = dossier.MeasureRichClubCoefficient
...
dossier.SaveDataframe(fitnessDF, "dossier_example_15.csv", "csv")
dossier.SaveDataframe(fitnessDF, "dossier_example_15.xlsx", "xlsx")
