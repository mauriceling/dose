"""!
Example 13 of DOSSIER [Functions to Analyze Simulation Results 
Database and Periodic Archives from DOSE (Digital Organism Simulation 
Environment) Simulations] - Process Unique Number of Enzymatic Genes. 

Date created: 13th December 2021
"""
try: 
...
dossier.SaveDataframe(fitnessDF, "dossier_example_13.csv", "csv")
dossier.SaveDataframe(fitnessDF, "dossier_example_13.xlsx", "xlsx")
